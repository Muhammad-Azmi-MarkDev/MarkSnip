<img width="128" height="128" alt="T (2) (1)" src="https://github.com/user-attachments/assets/58d7adf1-53db-496f-81ed-08ab79d622f1" />
...
* **In-Place Editor:** Annotate directly on the screen (arrows, redaction blocks, highlights, text) without opening a separate window.
* **Smart History:** Local database to view and retrieve your previous snips and extracted texts.
* **Offline & Secure:** 100% of the processing is done locally. No data leaves your machine.
...
| Key | Action |
| :--- | :--- |
| `Ctrl + Shift + Q` | Start Snipping Mode (Customizable in Settings) |
| `Ctrl + C` | Copy image or text to clipboard |
| `Ctrl + S` | Save annotated image to file |
| `Ctrl + Z / Y` | Undo / Redo annotations |
